...
二、使用规则
您必须同意不发表带有辱骂、淫秽、粗俗、诽谤、带有仇恨性、恐吓的、不健康的或是任何违反法律的内容（包括违反 熊猫之家 Panda Stay Home《社群指南》或法律）。如果您这样做将导致您的账户将立即和永久性地被封锁，该 IP 地址的所有用户都将被记录。
...
四、发布声明
在 熊猫之家 Panda Stay Home 发布的帖子需要满足下面的要求：
