const guidelines = [
  {
    title: "裸露或色情内容",
    content:
      "熊猫之家 Panda Stay Home 的目的不是为了宣传色情内容或露骨内容。如果您的内容有此类内容，即使是关于您自己的图片，也请勿在 熊猫之家 Panda Stay Home 上发布。另外请注意，我们与执法部门密切合作，会举报任何关于剥削儿童的内容。",
  },
  {
    title: "有危害性或危险性的内容",
    content:
  ...
  },
  {
    title: "骚扰和网络欺凌",
    content:
      "在 熊猫之家 Panda Stay Home 上发布骚扰性内容和评论是不当的做法。如果骚扰演变成了恶意攻击，内容和评论可能会被举报并移除。",
  },
  {
  ...
  },
  {
    title: "威胁",
    content:
      "恃强凌弱、跟踪、威胁、骚扰、胁迫、侵犯隐私、泄露他人的个人信息以及煽动他人进行暴力行为或违反使用条款等行为将受到严肃处理。若发现任何人有以上行为，我们可能会永远禁止其登录 熊猫之家 Panda Stay Home。",
  },
  {
    title: "版权",
    content:
  ...
  },
  {
    title: "儿童安全",
    content:
      "我们保护 熊猫之家 Panda Stay Home 生态系统中的未成年人。同时请注意，我们与执法部门有着密切的合作，任何危害儿童的内容或行为都会遭到举报。",
  },
]
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="bg-blue-50 rounded-xl p-6 mb-8">
        <p className="text-gray-700 leading-relaxed">
          使用 <strong>熊猫之家 Panda Stay Home</strong> 时，您会置身于一个成员遍布世界各地的大家庭。熊猫之家 Panda Stay Home 上每个精彩的社区功能都是以一定程度的信任为基础的。数以百万计的用户都尊重这份信任，我们希望您也承担起相应的责任。为确保每个人都能获得有趣又愉快的 熊猫之家 Panda Stay Home 使用体验，最好的方式就是遵循以下这些准则。
        </p>
        <p className="text-gray-700 leading-relaxed mt-3">
          您可能不喜欢在 熊猫之家 Panda Stay Home 上看到某些内容。如果您认为某些内容是不当内容，请使用举报功能将其提交给我们的员工进行审核。我们的员工全年无休，会仔细审核被举报的内容，判断它们是否违反了我们的社区准则。
        </p>
      </div>
      ...
      <div className="mt-8 bg-gray-50 rounded-xl p-6 text-sm text-gray-500 leading-relaxed">
        如果 熊猫之家 Panda Stay Home 用户在平台内外的行为伤害了我们的用户、社区、员工或生态系统，我们可能会综合考虑多种因素，包括但不限于其行为的恶劣程度以及是否属于习惯性有害行为，来采取相应措施。对于这类行为，我们轻则会禁言，重则会终止其帐号。
      </div>
    </div>
  )
}
